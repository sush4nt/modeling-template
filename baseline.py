...
class BaselineClfModeling(object):
    ...
    def evaluate(self):
        try:
            ...
            print("\n" + "="*100)
            print(" " * 40 + "LogisticRegression()")
            print("="*100)
            
            print("="*40 + " Model Performance Metrics " + "="*40)
            print(f"{'Train accuracy:':<25} {self.train_accuracy:.2f}")
            print(f"{'Test accuracy:':<25} {self.test_accuracy:.2f}")
            print(f"{'Train F1 Score:':<25} {self.train_f1:.3f}")
            print(f"{'Test F1 Score:':<25} {self.test_f1:.3f}")
            print("="*100)
            ...
            print("\n" + "="*40 + " Additional Metrics " + "="*40)
            print(f"{'Precision Score:':<25} {self.precision:.3f}")
            print(f"{'Recall Score:':<25} {self.recall:.3f}")
            print(f"{'ROC AUC Score:':<25} {self.roc_auc:.3f}")
            print("="*100 + "\n")
            self._plot_roc()
            
            print("="*40 + " Classification Report " + "="*40)
            print(self.classify_report)
            print("="*100 + "\n")
            self._plot_pr()
...
class BaselineRegModeling(object):
    def __init__(self, estimator, X_train, y_train, X_test, y_test):
        self.estimator = estimator
        self.X_train = X_train
        self.y_train = y_train
    ...
    def evaluate(self):
        try:
            ...
            print("\n" + "="*100)
            print(" " * 40 + f"{self.estimator.__class__.__name__}")
            print("="*100)
            
            print("="*40 + " Model Performance Metrics " + "="*40)
            print(f"{'Train RMSE:':<25} {self.train_rmse:.3f}")
            print(f"{'Test RMSE:':<25} {self.test_rmse:.3f}")
            print(f"{'Train MAE:':<25} {self.train_mae:.3f}")
            print(f"{'Test MAE:':<25} {self.test_mae:.3f}")
            print(f"{'Train R^2 Score:':<25} {self.train_r2:.3f}")
            print(f"{'Test R^2 Score:':<25} {self.test_r2:.3f}")
            print(f"{'Train MAPE:':<25} {self.train_mape:.3f}")
            print(f"{'Test MAPE:':<25} {self.test_mape:.3f}")
            print("="*100)
